...
const screens = [
  ['0', '#dashboardScreen'], ['1', '#leadsScreen'], ['2', '#clientsScreen'],
  ['3', '#proposalsScreen'], ['4', '#projectsScreen'], ['5', '#invoicesScreen'],
  ['6', '#paymentsScreen'], ['7', '#expensesScreen'], ['8', '#profitScreen'],
  ['9', '#cashflowScreen'], ['10', '#settingsScreen']
];

test.describe('B14 module navigation and responsive surfaces', () => {
  ...
  test('dashboard, profit and cashflow surfaces expose core outputs', async ({ page }) => {
    await page.goto('/app/index.html');
  ...
  test('core screens remain horizontally contained on mobile', async ({ page }) => {
    await page.goto('/app/index.html');
